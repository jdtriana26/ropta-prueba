      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${filter === 'all' ? 'bg-brand-400 text-white' : 'bg-white text-gray-500 hover:text-brand-500'}`}
          >
            Todos
          </button>
          {STATUSES.map(s => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${filter === s.value ? 'bg-brand-400 text-white' : 'bg-white text-gray-500 hover:text-brand-500'}`}
            >
              {s.label}
            </button>
          ))}
              ...
              <div key={order.id} className="bg-white rounded-2xl shadow-sm p-5">
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-display font-extrabold text-brand-500">
