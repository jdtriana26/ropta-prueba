                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {addr.is_default && (
                          <span className="badge bg-brand-50 text-brand-600 text-[10px]">Principal</span>
                        )}
                      </div>
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    {!addr.is_default && (
                      <button
                        ...
                        className="text-xs text-gray-400 hover:text-brand-500 transition-colors px-2 py-1 rounded-lg hover:bg-brand-50"
                      >
                        Principal
                      </button>
                    )}
